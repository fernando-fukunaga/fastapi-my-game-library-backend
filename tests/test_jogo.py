...
class TestJogo:
    ...
    @patch(patch_select_usuario_for_authentication)
    def test_atualizar_jogo_com_string_retorna_422(self, mock_authenticate):
        mock_authenticate.return_value = mock_user_model
    ...
    @patch(patch_select_plataformas)
    @patch(patch_select_jogos)
    @patch(patch_delete_jogo)
    def test_deletar_jogo_corretamente_retorna_204(
        self,
        mock_delete,
        mock_select_jogos,
        mock_select_plataformas,
    ...
    @patch(patch_select_plataformas)
    @patch(patch_select_jogos)
    def test_deletar_jogo_inexistente_ou_nao_pertencente_ao_usuario_logado_retorna_404(
        self,
        mock_select_jogos,
        mock_select_plataformas,
        mock_authenticate
    ...
    @patch(patch_select_usuario_for_authentication)
    def test_deletar_jogo_com_string_retorna_422(self, mock_authenticate):
        mock_authenticate.return_value = mock_user_model
